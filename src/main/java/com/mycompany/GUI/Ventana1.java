...
public class Ventana1 extends javax.swing.JFrame {
    ...
    public Ventana1(String role, int userId) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Login1Layout.setVerticalGroup(
            ...
            .addComponent(jLayeredPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 574, Short.MAX_VALUE)
        );
...
/*LOGICA
    ...
    public void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana1(role, userId).setVisible(true);
            }
        });
    }
