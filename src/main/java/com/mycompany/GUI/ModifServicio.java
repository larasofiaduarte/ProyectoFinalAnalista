 ...
 * @author duart
 */
public class ModifServicio extends javax.swing.JFrame {
     ...
     */
    public ModifServicio(int numServicio) {
        initComponents();
    ...
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifServicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifServicio(numServicio).setVisible(true);
            }
        });
    }
    ...
    private void cargarDatos(int numServicio) {
        this.ser = control.findServicio(numServicio);
