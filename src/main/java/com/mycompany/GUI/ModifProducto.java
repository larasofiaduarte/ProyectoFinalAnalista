...
public class ModifProducto extends javax.swing.JFrame {
    ...
    public ModifProducto(int numProducto) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblCargaEmp.setText("Modificación de Productos");
    ...
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifProducto(numProducto).setVisible(true);
            }
        });
    }
